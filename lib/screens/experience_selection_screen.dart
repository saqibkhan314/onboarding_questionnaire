...
//       ref.read(experiencesProvider.notifier).loadExperiences();
//     });
//   }
...
//     ref.read(onboardingProvider.notifier).toggleExperienceSelection(experienceId);
//   }
...
//     print('Selected Experiences: ${state.selectedExperienceIds}');
...
//           // Content
//           _buildContent(experiencesState, onboardingState),
//         ],
//       ),
//     );
//   }
...
//   Widget _buildContent(AsyncValue<List<Experience>> experiencesState, OnboardingState onboardingState) {
...
//           _buildExperiencesList(experiencesState),
          
//           const SizedBox(height: 32),
          
//           // Description text field
//           _buildDescriptionField(onboardingState),
          
//           const SizedBox(height: 24),
          
//           // Next button
//           _buildNextButton(onboardingState),
...
//   Widget _buildExperiencesList(AsyncValue<List<Experience>> experiencesState) {
//     return SizedBox(
//       height: 160,
//       child: experiencesState.when(
...
//             final isSelected = ref.watch(onboardingProvider
//                 .select((state) => state.selectedExperienceIds.contains(experience.id)));
...
//   Widget _buildDescriptionField(OnboardingState onboardingState) {
//     return Padding(
//       padding: const EdgeInsets.symmetric(horizontal: 24),
//       child: Column(
//         crossAxisAlignment: CrossAxisAlignment.start,
...
//               ),
//               onChanged: (value) => ref.read(onboardingProvider.notifier).updateExperienceText(value),
...
//               child: Text(
//                 '${onboardingState.experienceText.length}/250',
...
//   Widget _buildNextButton(OnboardingState onboardingState) {
//     final hasSelection = onboardingState.selectedExperienceIds.isNotEmpty;
