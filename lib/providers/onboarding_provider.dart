...
// //   void setAudioPath(String path) { // Remove the nullable ? if you want to require a path
// //     state = state.copyWith(audioPath: path);
// //   }

// //   void setVideoPath(String path) { // Remove the nullable ? if you want to require a path
// //     state = state.copyWith(videoPath: path);
// //   }

// //   // Add methods to clear audio/video if needed
// //   void clearAudioPath() {
